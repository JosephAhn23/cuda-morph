...
_add(
    ...
    "Ensure msprof is properly configured. Check file permissions on profiling output directory.",
)
...
_add(
    ...
    cann_versions="7.0+ (all 910 variants)",
    added_in="0.3.0",
)
...
def translate_error(code: any) -> ErrorInfo | None:
